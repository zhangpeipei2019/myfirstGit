...
//页面加载函数
	$(function(){
		//页面加载函数加载树
		$("#tree").tree({
			lines:false,//树形目录的线出现
			url:'auth?action=menu&parentId=-1',//发起异步请求的url
		...
		function openTab(node){
			...
			if($("#tabs").tabs("exists",node.text)){
				...
				$("#tabs").tabs("add",{
					...
					content:content//选项卡显示内容--》为当前权限路径的url内容
				});
			}
		}
	});
...
<div region="south" style="height: 25px;padding: 5px;" align="center">
	版权所有 2018 zyx公司 <a href="http://www.zyx.com" target="_blank">www.zyx.com</a>
</div>
